import webStudio from "../../assets/web_studio.jpeg";
...
export const projects = [
  {
    ...
    title: "WebStudio",
    description:
      "Верстка веб-сайту для Веб Студії. Метою сайту є залучення клієнтів",
    technologies: "HTML, CSS, SCSS Java Script, GitHub",
    linkWeb: "https://vitaliy28031985.github.io/goit-markup-hw-08/index.html",
  ...
  },
  {
    ...
    title: "Petly",
    description:
      "Веб-застосунок створений для власників домашніх тварин. З його допомогою можна придбати домашнього улюбленця. Якщо хтось знайшов загублену тваринку то він може подати оголошення про знахідку. Також з допомогою застосунку можна віддати в добрі руки домашню тваринку.",
    technologies:
